...
export function FundingExplorer() {
  ...
  return <main>
    ...
    <section className="prototype" role="status"><strong>Prototipo UX verificabile.</strong> Le schede sono scenari dimostrativi, non bandi reali. Gli adapter live non sono ancora dichiarati completi.</section>
    ...
    <section className="info" id="info"><p className="eyebrow">Trasparenza</p><h2>La fonte ufficiale viene prima di tutto.</h2><p>Questo prototipo separa rilevanza psicologica e possibilità di partecipare. Nessuna scheda dimostrativa costituisce una valutazione di ammissibilità.</p></section>
