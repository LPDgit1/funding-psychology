...
export function FundingExplorer() {
  ...
  return <main>
    ...
    <section className="prototype" role="status"><strong>Prototipo UX verificabile.</strong> Le schede sono scenari dimostrativi, non bandi reali. L’adapter UE è stato verificato live, ma i dati non sono ancora sincronizzati nello snapshot pubblico.</section>
    ...
    <section className="info" id="info"><p className="eyebrow">Trasparenza</p><h2>La fonte ufficiale viene prima di tutto.</h2><p>Questo prototipo separa rilevanza psicologica e possibilità di partecipare. L’adapter Funding & Tenders Portal UE risponde live, mentre le schede mostrate qui restano scenari dimostrativi in attesa della persistenza e della sincronizzazione notturna.</p></section>
