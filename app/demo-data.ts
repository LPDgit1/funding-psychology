...
export const DEMO_OPPORTUNITIES: Opportunity[] = [
  {
    ...
    funder: "Esempio dimostrativo", programme: "Scenario UX", status: "OPEN", territory: "Veneto",
  ...
  },
  {
    ...
    funder: "Esempio dimostrativo", programme: "Scenario UX", status: "UPCOMING", territory: "Veneto",
  ...
  },
  {
    ...
    funder: "Esempio dimostrativo", programme: "Scenario UX", status: "OPEN", territory: "Italia",
  ...
  },
  {
    ...
    funder: "Esempio dimostrativo", programme: "Scenario UX", status: "UPCOMING", territory: "Unione Europea",
