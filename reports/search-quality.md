...
| `dipendenze giovani` | 1 | “Legami di libertà”: 10 milioni di euro per prevenire e contrastare le dipendenze tra gli adolescent |
| `burnout lavoratori` | 0 | — |
| `psicologia anziani` | 0 | — |
| `migrazione trauma` | 0 | — |
| `inclusione sociale disabilità` | 25 | Provincia Autonoma di Trento - Contributo per l’attività di tutoraggio a favore del tirocinante con ; Voucher per il lavoro per persone con disabilità - Veneto Lavoro; Dote Impresa Collocamento Mirato Disabili - Annualità 2025 - Provincia di Pavia; Dote Impresa Collocamento Mirato Asse I - Provincia di Como - FONDO 2024; Avviso pubblico per la presentazione di domande di contributo in favore di datori di lavoro privati  |
| `AI salute mentale` | 0 | — |
