...
MACRO_RULES = {
    ...
    "Violenza, trauma e tutela": (
        "violenza", "trauma", "abuso", "gender-based violence", "domestic violence",
        "victim protection", "child protection", "protection from violence",
        "protection against abuse", "protection of minors",
    ),
...
POSITIVE_SIGNALS: tuple[tuple[str, float], ...] = (
    ...
    ("violenza", 3), ("gender-based violence", 5), ("domestic violence", 5),
    ("victim protection", 4), ("child protection", 4), ("protection from violence", 5),
    ("protection against abuse", 5), ("protection of minors", 4),
    ("adolescent", 3), ("disabil", 2), ("caregiver", 2),
